#ifndef CALIB_BARREL_LEFT_OFFSET1_BUNCH0_3_H
#define CALIB_BARREL_LEFT_OFFSET1_BUNCH0_3_H

#include "tofcalgsec/TofCalib.h"

const int nBarrelLeft_Offset1_bunch0_3 = 7;

class calib_barrel_left_offset1_bunch0_3:public TofCalib {
 public:
  calib_barrel_left_offset1_bunch0_3():TofCalib( nBarrelLeft_Offset1_bunch0_3 ) {
