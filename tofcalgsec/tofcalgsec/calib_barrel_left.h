#ifndef CALIB_BARREL_LEFT_H
#define CALIB_BARREL_LEFT_H

#include "tofcalgsec/TofCalib.h"

const int nBarrelLeft = 7;

class calib_barrel_left:public TofCalib {
 public:
  calib_barrel_left():TofCalib( nBarrelLeft ) {
    m_name = string("calib_barrel_left");
  }
