#ifndef CALIB_BARREL_RIGHT_OFFSET2_BUNCH2_3_H
#define CALIB_BARREL_RIGHT_OFFSET2_BUNCH2_3_H

#include "tofcalgsec/TofCalib.h"

const int nBarrelRight_Offset2_bunch2_3 = 7;

class calib_barrel_right_offset2_bunch2_3:public TofCalib {
 public:
  calib_barrel_right_offset2_bunch2_3():TofCalib( nBarrelRight_Offset2_bunch2_3 ) {
