#ifndef CALIB_BARREL_RIGHT_OFFSET1_BUNCH2_4_H
#define CALIB_BARREL_RIGHT_OFFSET1_BUNCH2_4_H

#include "tofcalgsec/TofCalib.h"

const int nBarrelRight_Offset1_bunch2_4 = 7;

class calib_barrel_right_offset1_bunch2_4:public TofCalib {
 public:
  calib_barrel_right_offset1_bunch2_4():TofCalib( nBarrelRight_Offset1_bunch2_4 ) {
    m_name = string("calib_barrel_right_offset1_bunch2");
  }
