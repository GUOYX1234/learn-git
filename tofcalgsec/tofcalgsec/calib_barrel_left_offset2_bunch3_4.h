#ifndef CALIB_BARREL_LEFT_OFFSET2_BUNCH3_4_H
#define CALIB_BARREL_LEFT_OFFSET2_BUNCH3_4_H

#include "tofcalgsec/TofCalib.h"

const int nBarrelLeft_Offset2_bunch3_4 = 7;

class calib_barrel_left_offset2_bunch3_4:public TofCalib {
 public:
  calib_barrel_left_offset2_bunch3_4():TofCalib( nBarrelLeft_Offset2_bunch3_4 ) {
