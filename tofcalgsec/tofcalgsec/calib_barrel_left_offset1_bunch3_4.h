#ifndef CALIB_BARREL_LEFT_OFFSET1_BUNCH3_4_H
#define CALIB_BARREL_LEFT_OFFSET1_BUNCH3_4_H

#include "tofcalgsec/TofCalib.h"

const int nBarrelLeft_Offset1_bunch3_4 = 7;

class calib_barrel_left_offset1_bunch3_4:public TofCalib {
 public:
  calib_barrel_left_offset1_bunch3_4():TofCalib( nBarrelLeft_Offset1_bunch3_4 ) {
